    ...
    if (turn === 0) {
      return {
        ...
        operations: [
          ...
          { op: "transition_artifact", artifactId: "artifact://RequirementsDoc/requirements/1", to: "READY_FOR_REVIEW" },
    ...
    if (patchReady) {
      ...
      return {
        ...
        operations: [
          ...
          { op: "transition_artifact", artifactId: `artifact://TestReport/tests-${patch?.name ?? "x"}/1`, to: "READY_FOR_REVIEW" },
    ...
    return {
      ...
      operations: [
        ...
        ...(firstScan ? ([
          ...
          { op: "transition_artifact", artifactId: "artifact://SecurityReport/security-scan/1", to: "READY_FOR_REVIEW" },
